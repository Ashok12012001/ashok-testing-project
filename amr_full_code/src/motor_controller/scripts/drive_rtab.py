    ...
    try:
        ...
        try:
            subprocess.run(
                [
                    "python3",
                    "/home/fldec/nissan_ws/src/mobile_robot_autonomous_navigation/script/rtab_last_read_last_pose.py",
                ],
                check=True,
            )
            print("read_amcl ")
        ...
        if ip_address == ssid and start_please_received:
            ...
            try:
                subprocess.run(
                    [
                        "python3",
                        "/home/fldec/nissan_ws/src/mobile_robot_autonomous_navigation/script/rtab_map_store.py",
                    ],
                    check=True,
                )
                print("amcl_store ")
