...
(cl:defmethod cl:initialize-instance :after ((m <Navigate2DFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Navigate2DFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package-msg:<Navigate2DFeedback> is deprecated: use package-msg:Navigate2DFeedback instead.")))

(cl:ensure-generic-function 'distance_to_point-val :lambda-list '(m))
(cl:defmethod distance_to_point-val ((m <Navigate2DFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package-msg:distance_to_point-val is deprecated.  Use package-msg:distance_to_point instead.")
  (distance_to_point m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Navigate2DFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%float32 distance_to_point~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Navigate2DFeedback)))
  "Returns full string definition for message of type 'Navigate2DFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%float32 distance_to_point~%~%~%"))
