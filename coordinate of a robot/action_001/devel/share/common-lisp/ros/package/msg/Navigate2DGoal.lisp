...
(cl:defmethod cl:initialize-instance :after ((m <Navigate2DGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Navigate2DGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package-msg:<Navigate2DGoal> is deprecated: use package-msg:Navigate2DGoal instead.")))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <Navigate2DGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package-msg:point-val is deprecated.  Use package-msg:point instead.")
  (point m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Navigate2DGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%geometry_msgs/Point point ~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Navigate2DGoal)))
  "Returns full string definition for message of type 'Navigate2DGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%geometry_msgs/Point point ~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
