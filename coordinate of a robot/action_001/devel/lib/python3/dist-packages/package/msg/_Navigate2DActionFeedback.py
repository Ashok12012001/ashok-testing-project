...
"""autogenerated by genpy from package/Navigate2DActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class Navigate2DActionFeedback(genpy.Message):
  ...
  _type = "package/Navigate2DActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','package/Navigate2DFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = package.msg.Navigate2DFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = package.msg.Navigate2DFeedback()
