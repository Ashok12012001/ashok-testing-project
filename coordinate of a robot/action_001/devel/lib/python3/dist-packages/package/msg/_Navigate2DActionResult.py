...
"""autogenerated by genpy from package/Navigate2DActionResult.msg. Do not edit."""
import codecs
import sys
...
class Navigate2DActionResult(genpy.Message):
  ...
  _type = "package/Navigate2DActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','package/Navigate2DResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = package.msg.Navigate2DResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = package.msg.Navigate2DResult()
