...
"""autogenerated by genpy from asho/ActionNameAction.msg. Do not edit."""
import codecs
import sys
...
class ActionNameAction(genpy.Message):
  _md5sum = "2035890dc4e1c409984416f99b0f19fb"
  _type = "asho/ActionNameAction"
...
"""
  ...
  _slot_types = ['asho/ActionNameActionGoal','asho/ActionNameActionResult','asho/ActionNameActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionNameAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = asho.msg.ActionNameActionGoal()
      if self.action_result is None:
        self.action_result = asho.msg.ActionNameActionResult()
      if self.action_feedback is None:
        self.action_feedback = asho.msg.ActionNameActionFeedback()
    else:
      self.action_goal = asho.msg.ActionNameActionGoal()
      self.action_result = asho.msg.ActionNameActionResult()
      self.action_feedback = asho.msg.ActionNameActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_f3I().pack(_x.action_goal.goal.target_position, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target_position, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
