...
"""autogenerated by genpy from asho/ActionNameActionResult.msg. Do not edit."""
import codecs
import sys
...
class ActionNameActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "asho/ActionNameActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','asho/ActionNameResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionNameActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = asho.msg.ActionNameResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = asho.msg.ActionNameResult()
