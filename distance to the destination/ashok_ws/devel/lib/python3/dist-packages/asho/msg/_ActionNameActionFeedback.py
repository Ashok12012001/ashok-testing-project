...
"""autogenerated by genpy from asho/ActionNameActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ActionNameActionFeedback(genpy.Message):
  _md5sum = "666d1d759f2ab5bb4b72cf6f0b5024ac"
  _type = "asho/ActionNameActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','asho/ActionNameFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionNameActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = asho.msg.ActionNameFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = asho.msg.ActionNameFeedback()
