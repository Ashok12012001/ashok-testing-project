...
"""autogenerated by genpy from package/MyMessage.msg. Do not edit."""
import codecs
import sys
...
class MyMessage(genpy.Message):
  _md5sum = "b2c3af80379375679a75f5d26c24ce1b"
  _type = "package/MyMessage"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#MyMessage.msg

string name
int32 id
float32[] values
"""
  __slots__ = ['name','id','values']
